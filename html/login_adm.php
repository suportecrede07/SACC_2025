...
<body>
  ...
  <header style="background-color: #ffffff; width: 100%; height: 88px; display: flex; align-items: center; justify-content: center; border-bottom: 1px solid #e2e8f0;">
    <a href="../index.html" class="d-flex align-items-center justify-content-center">
      <img src="../assets/img/SACC.png" alt="SACC Logo" style="height: 56px; max-height: 56px; width: auto; object-fit: contain;">
    </a>
  </header>
  ...
  <main class="flex-grow-1 d-flex flex-column align-items-center justify-content-center" style="padding: 15px;">
    ...
    <div class="bg-white rounded-4 shadow-lg p-4 p-md-5 w-100 d-flex flex-column" style="max-width: 450px; border: 1px solid #f2f2f2;">
      ...
      <div class="text-center mb-4">
        <h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size: 1.8rem; font-weight: 500; color: #222;">Admin</h1>
        <p class="text-muted" style="font-size: 0.9rem;">Gerenciamento do sistema</p>
      </div>
      ...
      <form method="POST" action="../php/Adm.php" id="loginForm">
        ...
        <div class="mb-3 text-start">
          ...
          <input class="form-control" type="text" name="usuario" required placeholder="Digite seu usuário" />
        </div>
      ...
      <div class="text-center mt-2">
        ...
        <img src="../assets/img/crede7.png" alt="Crede 7 Canindé" class="img-fluid" style="height: 50px; width: auto;">
      </div>
