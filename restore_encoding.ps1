...
$functions = @"
        ...
        function criterioDesempateUsado(`$a, `$b, `$criteriosDesempate) {
          ...
          if (`$a['total_trabalhos'] !== `$b['total_trabalhos']) { return ['indice' => 'Total Trabalhos', 'criterio' => 'Maior Nº Trabalhos']; }
          /* -- DESATIVADOS A PEDIDO --
          if (`$a['IDEB'] !== `$b['IDEB']) { return ['indice' => 'IDEB', 'criterio' => 'Maior IDEB']; }
